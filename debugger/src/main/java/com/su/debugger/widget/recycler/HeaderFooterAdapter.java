...
public abstract class HeaderFooterAdapter extends RecyclerView.Adapter<HeaderFooterAdapter.HeaderFooterViewHolder> {
    ...
    @Override
    public abstract HeaderFooterViewHolder onCreateViewHolder(ViewGroup parent, int viewType);

    @Override
    public abstract void onBindViewHolder(HeaderFooterViewHolder holder, int position);
