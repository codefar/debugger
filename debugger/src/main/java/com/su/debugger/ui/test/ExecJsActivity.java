...
public class ExecJsActivity extends BaseAppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            mFunction = savedInstanceState.getParcelable("function");
        }
    ...
    @Override
    public int menuRes() {
        return R.menu.debugger_file_menu;
    }
    ...
    private class ParametersPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            EditText view = (EditText) mInflater.inflate(R.layout.debugger_tab_js_debug, container, false);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putParcelable("function", mFunction);
